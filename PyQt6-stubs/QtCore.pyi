...
class QObject(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def findChildren(self, types: typing.Tuple[typing.Type[QObject], ...], name: str = ..., options: Qt.FindChildOption = ...) -> typing.List[QObjectT]: ...
    @typing.overload
    def findChildren(self, type: typing.Type[QObjectT], re: "QRegularExpression", options: Qt.FindChildOption = ...) -> typing.List[QObjectT]: ...
    @typing.overload
    def findChildren(self, types: typing.Tuple[typing.Type[QObject], ...], re: "QRegularExpression", options: Qt.FindChildOption = ...) -> typing.List[QObjectT]: ...
    @typing.overload
    def findChild(self, type: typing.Type[QObjectT], name: str = ..., options: Qt.FindChildOption = ...) -> typing.Optional[QObjectT]: ...
    @typing.overload
    def findChild(self, types: typing.Tuple[typing.Type[QObject], ...], name: str = ..., options: Qt.FindChildOption = ...) -> typing.Optional[QObjectT]: ...
    @staticmethod
...
class QAbstractNativeEventFilter(PyQt6.sip.simplewrapper):
    def __init__(self) -> None: ...
    def nativeEventFilter(self, eventType: typing.Union["QByteArray", bytes, bytearray], message: PyQt6.sip.voidptr) -> typing.Tuple[bool, int]: ...
...
class QBitArray(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def fill(self, value: bool, first: int, last: int) -> None: ...
    @typing.overload
...
class QByteArray(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, size: int, c: typing.Union["QByteArray", bytes, bytearray]) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromBase64(base64: typing.Union["QByteArray", bytes, bytearray], options: "QByteArray.Base64Option" = ...) -> "QByteArray": ...
    @typing.overload
    @staticmethod
...
class QByteArrayMatcher(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, pattern: typing.Union[QByteArray, bytes, bytearray], length: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def indexIn(self, str: typing.Union[QByteArray, bytes, bytearray], len: int, from_: int = ...) -> int: ...
    @typing.overload
...
class QCoreApplication(QObject):
    ...
    @staticmethod
    def exec() -> int: ...
    # Qt documentation: 'If no instance has been allocated, nullptr is returned.'
    @staticmethod
...
class QDataStream(QIODeviceBase):
    ...
    @typing.overload
    def __init__(self, a0: typing.Union[QByteArray, bytes, bytearray], flags: QIODeviceBase.OpenModeFlag) -> None: ...
    @typing.overload
