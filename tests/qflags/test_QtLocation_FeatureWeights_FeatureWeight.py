...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.FeatureWeights" and flag class "QGeoRouteRequest.FeatureWeight"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.FeatureWeight
MultiFlagClass = QtLocation.QGeoRouteRequest.FeatureWeights

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.FeatureWeight.NeutralFeatureWeight
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.FeatureWeight.PreferFeatureWeight
