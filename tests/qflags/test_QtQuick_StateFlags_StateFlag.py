...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGRenderNode.StateFlags" and flag class "QSGRenderNode.StateFlag"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGRenderNode.StateFlag
MultiFlagClass = QtQuick.QSGRenderNode.StateFlags

oneFlagRefValue1 = QtQuick.QSGRenderNode.StateFlag.DepthState
oneFlagRefValue2 = QtQuick.QSGRenderNode.StateFlag.StencilState
