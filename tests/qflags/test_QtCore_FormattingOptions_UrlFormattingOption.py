...
OneFlagClass = QtCore.QUrl.UrlFormattingOption
MultiFlagClass = QtCore.QUrl.FormattingOptions

oneFlagRefValue1 = QtCore.QUrl.None_
oneFlagRefValue2 = QtCore.QUrl.RemoveScheme
...
### Disable the tests on multiflag for QUrl.FormattingOptions because the implementation does not support anything.
'''
def test_on_multi_flag_class() -> None:
	oneFlagValue1 = oneFlagRefValue1
	multiFlagValue1 = MultiFlagClass(oneFlagValue1 | oneFlagValue1)
	multiFlagValue2 = MultiFlagClass(oneFlagValue1 | oneFlagValue1)
