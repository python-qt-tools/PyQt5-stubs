...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QLocalServer.SocketOptions" and flag class "QLocalServer.SocketOption"
from PyQt5 import QtNetwork

OneFlagClass = QtNetwork.QLocalServer.SocketOption
MultiFlagClass = QtNetwork.QLocalServer.SocketOptions

oneFlagRefValue1 = QtNetwork.QLocalServer.SocketOption.UserAccessOption
oneFlagRefValue2 = QtNetwork.QLocalServer.SocketOption.GroupAccessOption
