...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QCameraExposure.FlashModes" and flag class "QCameraExposure.FlashMode"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QCameraExposure.FlashMode
MultiFlagClass = QtMultimedia.QCameraExposure.FlashModes

oneFlagRefValue1 = QtMultimedia.QCameraExposure.FlashMode.FlashAuto
oneFlagRefValue2 = QtMultimedia.QCameraExposure.FlashMode.FlashOff
