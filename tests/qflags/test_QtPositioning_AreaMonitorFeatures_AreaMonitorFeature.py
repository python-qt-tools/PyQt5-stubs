...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoAreaMonitorSource.AreaMonitorFeatures" and flag class "QGeoAreaMonitorSource.AreaMonitorFeature"
from PyQt5 import QtPositioning

OneFlagClass = QtPositioning.QGeoAreaMonitorSource.AreaMonitorFeature
MultiFlagClass = QtPositioning.QGeoAreaMonitorSource.AreaMonitorFeatures

oneFlagRefValue1 = QtPositioning.QGeoAreaMonitorSource.AreaMonitorFeature.PersistentAreaMonitorFeature
oneFlagRefValue2 = QtPositioning.QGeoAreaMonitorSource.AreaMonitorFeature.AnyAreaMonitorFeature
