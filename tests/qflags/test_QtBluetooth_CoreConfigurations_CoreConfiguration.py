...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QBluetoothDeviceInfo.CoreConfigurations" and flag class "QBluetoothDeviceInfo.CoreConfiguration"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QBluetoothDeviceInfo.CoreConfiguration
MultiFlagClass = QtBluetooth.QBluetoothDeviceInfo.CoreConfigurations

oneFlagRefValue1 = QtBluetooth.QBluetoothDeviceInfo.CoreConfiguration.UnknownCoreConfiguration
oneFlagRefValue2 = QtBluetooth.QBluetoothDeviceInfo.CoreConfiguration.LowEnergyCoreConfiguration
