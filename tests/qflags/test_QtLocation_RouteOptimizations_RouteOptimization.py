...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.RouteOptimizations" and flag class "QGeoRouteRequest.RouteOptimization"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.RouteOptimization
MultiFlagClass = QtLocation.QGeoRouteRequest.RouteOptimizations

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.RouteOptimization.ShortestRoute
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.RouteOptimization.FastestRoute
