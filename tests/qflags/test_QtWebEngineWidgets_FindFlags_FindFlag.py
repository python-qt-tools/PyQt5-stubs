...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QWebEnginePage.FindFlags" and flag class "QWebEnginePage.FindFlag"
from PyQt5 import QtWebEngineWidgets

OneFlagClass = QtWebEngineWidgets.QWebEnginePage.FindFlag
MultiFlagClass = QtWebEngineWidgets.QWebEnginePage.FindFlags

oneFlagRefValue1 = QtWebEngineWidgets.QWebEnginePage.FindFlag.FindBackward
oneFlagRefValue2 = QtWebEngineWidgets.QWebEnginePage.FindFlag.FindCaseSensitively
