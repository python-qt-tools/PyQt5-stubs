...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoServiceProvider.RoutingFeatures" and flag class "QGeoServiceProvider.RoutingFeature"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoServiceProvider.RoutingFeature
MultiFlagClass = QtLocation.QGeoServiceProvider.RoutingFeatures

oneFlagRefValue1 = QtLocation.QGeoServiceProvider.RoutingFeature.NoRoutingFeatures
oneFlagRefValue2 = QtLocation.QGeoServiceProvider.RoutingFeature.OnlineRoutingFeature
