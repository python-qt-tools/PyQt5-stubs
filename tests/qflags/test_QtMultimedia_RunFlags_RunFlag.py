...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QVideoFilterRunnable.RunFlags" and flag class "QVideoFilterRunnable.RunFlag"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QVideoFilterRunnable.RunFlag
MultiFlagClass = QtMultimedia.QVideoFilterRunnable.RunFlags

oneFlagRefValue1 = QtMultimedia.QVideoFilterRunnable.RunFlag.LastInChain
oneFlagRefValue2 = QtMultimedia.QVideoFilterRunnable.RunFlag.LastInChain
