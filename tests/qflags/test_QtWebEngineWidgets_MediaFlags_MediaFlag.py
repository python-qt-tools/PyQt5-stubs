...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QWebEngineContextMenuData.MediaFlags" and flag class "QWebEngineContextMenuData.MediaFlag"
from PyQt5 import QtWebEngineWidgets

OneFlagClass = QtWebEngineWidgets.QWebEngineContextMenuData.MediaFlag
MultiFlagClass = QtWebEngineWidgets.QWebEngineContextMenuData.MediaFlags

oneFlagRefValue1 = QtWebEngineWidgets.QWebEngineContextMenuData.MediaFlag.MediaInError
oneFlagRefValue2 = QtWebEngineWidgets.QWebEngineContextMenuData.MediaFlag.MediaPaused
