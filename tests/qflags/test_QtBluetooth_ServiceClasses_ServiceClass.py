...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QBluetoothDeviceInfo.ServiceClasses" and flag class "QBluetoothDeviceInfo.ServiceClass"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QBluetoothDeviceInfo.ServiceClass
MultiFlagClass = QtBluetooth.QBluetoothDeviceInfo.ServiceClasses

oneFlagRefValue1 = QtBluetooth.QBluetoothDeviceInfo.ServiceClass.NoService
oneFlagRefValue2 = QtBluetooth.QBluetoothDeviceInfo.ServiceClass.PositioningService
