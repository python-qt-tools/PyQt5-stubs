...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGAbstractRenderer.ClearMode" and flag class "QSGAbstractRenderer.ClearModeBit"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGAbstractRenderer.ClearModeBit
MultiFlagClass = QtQuick.QSGAbstractRenderer.ClearMode

oneFlagRefValue1 = QtQuick.QSGAbstractRenderer.ClearModeBit.ClearColorBuffer
oneFlagRefValue2 = QtQuick.QSGAbstractRenderer.ClearModeBit.ClearDepthBuffer
