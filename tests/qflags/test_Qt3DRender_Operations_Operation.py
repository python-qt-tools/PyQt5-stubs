...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QMemoryBarrier.Operations" and flag class "QMemoryBarrier.Operation"
from PyQt5 import Qt3DRender

OneFlagClass = Qt3DRender.QMemoryBarrier.Operation
MultiFlagClass = Qt3DRender.QMemoryBarrier.Operations

oneFlagRefValue1 = Qt3DRender.QMemoryBarrier.Operation.None_
oneFlagRefValue2 = Qt3DRender.QMemoryBarrier.Operation.VertexAttributeArray
