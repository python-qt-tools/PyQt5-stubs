...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QMediaPlayer.Flags" and flag class "QMediaPlayer.Flag"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QMediaPlayer.Flag
MultiFlagClass = QtMultimedia.QMediaPlayer.Flags

oneFlagRefValue1 = QtMultimedia.QMediaPlayer.Flag.LowLatency
oneFlagRefValue2 = QtMultimedia.QMediaPlayer.Flag.StreamPlayback
