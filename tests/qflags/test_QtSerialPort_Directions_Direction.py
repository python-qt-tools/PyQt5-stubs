...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSerialPort.Directions" and flag class "QSerialPort.Direction"
from PyQt5 import QtSerialPort

OneFlagClass = QtSerialPort.QSerialPort.Direction
MultiFlagClass = QtSerialPort.QSerialPort.Directions

oneFlagRefValue1 = QtSerialPort.QSerialPort.Direction.Input
oneFlagRefValue2 = QtSerialPort.QSerialPort.Direction.Output
