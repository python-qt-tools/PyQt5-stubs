...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoServiceProvider.GeocodingFeatures" and flag class "QGeoServiceProvider.GeocodingFeature"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoServiceProvider.GeocodingFeature
MultiFlagClass = QtLocation.QGeoServiceProvider.GeocodingFeatures

oneFlagRefValue1 = QtLocation.QGeoServiceProvider.GeocodingFeature.NoGeocodingFeatures
oneFlagRefValue2 = QtLocation.QGeoServiceProvider.GeocodingFeature.OnlineGeocodingFeature
