...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QLowEnergyCharacteristic.PropertyTypes" and flag class "QLowEnergyCharacteristic.PropertyType"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QLowEnergyCharacteristic.PropertyType
MultiFlagClass = QtBluetooth.QLowEnergyCharacteristic.PropertyTypes

oneFlagRefValue1 = QtBluetooth.QLowEnergyCharacteristic.PropertyType.Unknown
oneFlagRefValue2 = QtBluetooth.QLowEnergyCharacteristic.PropertyType.Broadcasting
