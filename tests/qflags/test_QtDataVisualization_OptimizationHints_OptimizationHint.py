...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QAbstract3DGraph.OptimizationHints" and flag class "QAbstract3DGraph.OptimizationHint"
from PyQt5 import QtDataVisualization

OneFlagClass = QtDataVisualization.QAbstract3DGraph.OptimizationHint
MultiFlagClass = QtDataVisualization.QAbstract3DGraph.OptimizationHints

oneFlagRefValue1 = QtDataVisualization.QAbstract3DGraph.OptimizationHint.OptimizationDefault
oneFlagRefValue2 = QtDataVisualization.QAbstract3DGraph.OptimizationHint.OptimizationStatic
