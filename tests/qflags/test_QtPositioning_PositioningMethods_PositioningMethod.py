...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoPositionInfoSource.PositioningMethods" and flag class "QGeoPositionInfoSource.PositioningMethod"
from PyQt5 import QtPositioning

OneFlagClass = QtPositioning.QGeoPositionInfoSource.PositioningMethod
MultiFlagClass = QtPositioning.QGeoPositionInfoSource.PositioningMethods

oneFlagRefValue1 = QtPositioning.QGeoPositionInfoSource.PositioningMethod.NoPositioningMethods
oneFlagRefValue2 = QtPositioning.QGeoPositionInfoSource.PositioningMethod.SatellitePositioningMethods
