...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QCamera.LockTypes" and flag class "QCamera.LockType"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QCamera.LockType
MultiFlagClass = QtMultimedia.QCamera.LockTypes

oneFlagRefValue1 = QtMultimedia.QCamera.LockType.NoLock
oneFlagRefValue2 = QtMultimedia.QCamera.LockType.LockExposure
