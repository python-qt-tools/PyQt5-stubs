...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QWebEngineUrlScheme.Flags" and flag class "QWebEngineUrlScheme.Flag"
from PyQt5 import QtWebEngineCore

OneFlagClass = QtWebEngineCore.QWebEngineUrlScheme.Flag
MultiFlagClass = QtWebEngineCore.QWebEngineUrlScheme.Flags

oneFlagRefValue1 = QtWebEngineCore.QWebEngineUrlScheme.Flag.SecureScheme
oneFlagRefValue2 = QtWebEngineCore.QWebEngineUrlScheme.Flag.LocalScheme
