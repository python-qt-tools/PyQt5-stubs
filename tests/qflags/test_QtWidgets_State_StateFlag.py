...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QStyle.State" and flag class "QStyle.StateFlag"
from PyQt5 import QtWidgets

OneFlagClass = QtWidgets.QStyle.StateFlag
MultiFlagClass = QtWidgets.QStyle.State

oneFlagRefValue1 = QtWidgets.QStyle.StateFlag.State_None
oneFlagRefValue2 = QtWidgets.QStyle.StateFlag.State_Enabled
