...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QPolarChart.PolarOrientations" and flag class "QPolarChart.PolarOrientation"
from PyQt5 import QtChart

OneFlagClass = QtChart.QPolarChart.PolarOrientation
MultiFlagClass = QtChart.QPolarChart.PolarOrientations

oneFlagRefValue1 = QtChart.QPolarChart.PolarOrientation.PolarOrientationRadial
oneFlagRefValue2 = QtChart.QPolarChart.PolarOrientation.PolarOrientationAngular
