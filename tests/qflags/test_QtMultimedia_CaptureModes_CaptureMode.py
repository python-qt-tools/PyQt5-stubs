...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QCamera.CaptureModes" and flag class "QCamera.CaptureMode"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QCamera.CaptureMode
MultiFlagClass = QtMultimedia.QCamera.CaptureModes

oneFlagRefValue1 = QtMultimedia.QCamera.CaptureMode.CaptureViewfinder
oneFlagRefValue2 = QtMultimedia.QCamera.CaptureMode.CaptureStillImage
