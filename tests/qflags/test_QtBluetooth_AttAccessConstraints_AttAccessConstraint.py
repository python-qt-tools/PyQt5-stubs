...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QBluetooth.AttAccessConstraints" and flag class "QBluetooth.AttAccessConstraint"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QBluetooth.AttAccessConstraint
MultiFlagClass = QtBluetooth.QBluetooth.AttAccessConstraints

oneFlagRefValue1 = QtBluetooth.QBluetooth.AttAccessConstraint.AttAuthorizationRequired
oneFlagRefValue2 = QtBluetooth.QBluetooth.AttAccessConstraint.AttAuthenticationRequired
