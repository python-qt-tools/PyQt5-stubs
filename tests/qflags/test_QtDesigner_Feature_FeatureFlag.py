...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QDesignerFormWindowInterface.Feature" and flag class "QDesignerFormWindowInterface.FeatureFlag"
from PyQt5 import QtDesigner

OneFlagClass = QtDesigner.QDesignerFormWindowInterface.FeatureFlag
MultiFlagClass = QtDesigner.QDesignerFormWindowInterface.Feature

oneFlagRefValue1 = QtDesigner.QDesignerFormWindowInterface.FeatureFlag.EditFeature
oneFlagRefValue2 = QtDesigner.QDesignerFormWindowInterface.FeatureFlag.GridFeature
