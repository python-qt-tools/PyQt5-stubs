...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGMaterialRhiShader.GraphicsPipelineState.ColorMask" and flag class "QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent
MultiFlagClass = QtQuick.QSGMaterialRhiShader.GraphicsPipelineState.ColorMask

oneFlagRefValue1 = QtQuick.QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent.R
oneFlagRefValue2 = QtQuick.QSGMaterialRhiShader.GraphicsPipelineState.ColorMaskComponent.G
