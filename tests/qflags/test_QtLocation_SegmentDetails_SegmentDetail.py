...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.SegmentDetails" and flag class "QGeoRouteRequest.SegmentDetail"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.SegmentDetail
MultiFlagClass = QtLocation.QGeoRouteRequest.SegmentDetails

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.SegmentDetail.NoSegmentData
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.SegmentDetail.BasicSegmentData
