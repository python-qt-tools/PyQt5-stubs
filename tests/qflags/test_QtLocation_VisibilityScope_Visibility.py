...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QLocation.VisibilityScope" and flag class "QLocation.Visibility"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QLocation.Visibility
MultiFlagClass = QtLocation.QLocation.VisibilityScope

oneFlagRefValue1 = QtLocation.QLocation.Visibility.UnspecifiedVisibility
oneFlagRefValue2 = QtLocation.QLocation.Visibility.DeviceVisibility
