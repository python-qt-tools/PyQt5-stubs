...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSsl.SslOptions" and flag class "QSsl.SslOption"
from PyQt5 import QtNetwork

OneFlagClass = QtNetwork.QSsl.SslOption
MultiFlagClass = QtNetwork.QSsl.SslOptions

oneFlagRefValue1 = QtNetwork.QSsl.SslOption.SslOptionDisableEmptyFragments
oneFlagRefValue2 = QtNetwork.QSsl.SslOption.SslOptionDisableSessionTickets
