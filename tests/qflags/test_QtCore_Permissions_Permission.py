...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QFileDevice.Permissions" and flag class "QFileDevice.Permission"
from PyQt5 import QtCore

OneFlagClass = QtCore.QFileDevice.Permission
MultiFlagClass = QtCore.QFileDevice.Permissions

oneFlagRefValue1 = QtCore.QFileDevice.Permission.ReadOwner
oneFlagRefValue2 = QtCore.QFileDevice.Permission.WriteOwner
