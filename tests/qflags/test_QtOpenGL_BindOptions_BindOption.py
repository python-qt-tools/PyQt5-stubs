...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGLContext.BindOptions" and flag class "QGLContext.BindOption"
from PyQt5 import QtOpenGL

OneFlagClass = QtOpenGL.QGLContext.BindOption
MultiFlagClass = QtOpenGL.QGLContext.BindOptions

oneFlagRefValue1 = QtOpenGL.QGLContext.BindOption.NoBindOption
oneFlagRefValue2 = QtOpenGL.QGLContext.BindOption.InvertedYBindOption
