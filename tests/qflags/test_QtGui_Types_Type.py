...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QOpenGLDebugMessage.Types" and flag class "QOpenGLDebugMessage.Type"
from PyQt5 import QtGui

OneFlagClass = QtGui.QOpenGLDebugMessage.Type
MultiFlagClass = QtGui.QOpenGLDebugMessage.Types

oneFlagRefValue1 = QtGui.QOpenGLDebugMessage.Type.InvalidType
oneFlagRefValue2 = QtGui.QOpenGLDebugMessage.Type.ErrorType
