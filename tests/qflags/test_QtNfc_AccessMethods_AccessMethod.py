...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QNearFieldTarget.AccessMethods" and flag class "QNearFieldTarget.AccessMethod"
from PyQt5 import QtNfc

OneFlagClass = QtNfc.QNearFieldTarget.AccessMethod
MultiFlagClass = QtNfc.QNearFieldTarget.AccessMethods

oneFlagRefValue1 = QtNfc.QNearFieldTarget.AccessMethod.UnknownAccess
oneFlagRefValue2 = QtNfc.QNearFieldTarget.AccessMethod.NdefAccess
