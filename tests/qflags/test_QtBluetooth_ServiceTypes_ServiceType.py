...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QLowEnergyService.ServiceTypes" and flag class "QLowEnergyService.ServiceType"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QLowEnergyService.ServiceType
MultiFlagClass = QtBluetooth.QLowEnergyService.ServiceTypes

oneFlagRefValue1 = QtBluetooth.QLowEnergyService.ServiceType.PrimaryService
oneFlagRefValue2 = QtBluetooth.QLowEnergyService.ServiceType.IncludedService
