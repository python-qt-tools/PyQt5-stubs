...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoServiceProvider.MappingFeatures" and flag class "QGeoServiceProvider.MappingFeature"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoServiceProvider.MappingFeature
MultiFlagClass = QtLocation.QGeoServiceProvider.MappingFeatures

oneFlagRefValue1 = QtLocation.QGeoServiceProvider.MappingFeature.NoMappingFeatures
oneFlagRefValue2 = QtLocation.QGeoServiceProvider.MappingFeature.OnlineMappingFeature
