...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QAbstractAxis.AxisTypes" and flag class "QAbstractAxis.AxisType"
from PyQt5 import QtChart

OneFlagClass = QtChart.QAbstractAxis.AxisType
MultiFlagClass = QtChart.QAbstractAxis.AxisTypes

oneFlagRefValue1 = QtChart.QAbstractAxis.AxisType.AxisTypeNoAxis
oneFlagRefValue2 = QtChart.QAbstractAxis.AxisType.AxisTypeValue
