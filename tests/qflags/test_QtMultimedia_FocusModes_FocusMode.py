...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QCameraFocus.FocusModes" and flag class "QCameraFocus.FocusMode"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QCameraFocus.FocusMode
MultiFlagClass = QtMultimedia.QCameraFocus.FocusModes

oneFlagRefValue1 = QtMultimedia.QCameraFocus.FocusMode.ManualFocus
oneFlagRefValue2 = QtMultimedia.QCameraFocus.FocusMode.HyperfocalFocus
