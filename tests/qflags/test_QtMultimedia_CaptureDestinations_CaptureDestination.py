...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QCameraImageCapture.CaptureDestinations" and flag class "QCameraImageCapture.CaptureDestination"
from PyQt5 import QtMultimedia

OneFlagClass = QtMultimedia.QCameraImageCapture.CaptureDestination
MultiFlagClass = QtMultimedia.QCameraImageCapture.CaptureDestinations

oneFlagRefValue1 = QtMultimedia.QCameraImageCapture.CaptureDestination.CaptureToFile
oneFlagRefValue2 = QtMultimedia.QCameraImageCapture.CaptureDestination.CaptureToBuffer
