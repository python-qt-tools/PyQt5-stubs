...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QNetworkInterface.InterfaceFlags" and flag class "QNetworkInterface.InterfaceFlag"
from PyQt5 import QtNetwork

OneFlagClass = QtNetwork.QNetworkInterface.InterfaceFlag
MultiFlagClass = QtNetwork.QNetworkInterface.InterfaceFlags

oneFlagRefValue1 = QtNetwork.QNetworkInterface.InterfaceFlag.IsUp
oneFlagRefValue2 = QtNetwork.QNetworkInterface.InterfaceFlag.IsRunning
