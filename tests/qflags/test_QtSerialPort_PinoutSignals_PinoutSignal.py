...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSerialPort.PinoutSignals" and flag class "QSerialPort.PinoutSignal"
from PyQt5 import QtSerialPort

OneFlagClass = QtSerialPort.QSerialPort.PinoutSignal
MultiFlagClass = QtSerialPort.QSerialPort.PinoutSignals

oneFlagRefValue1 = QtSerialPort.QSerialPort.PinoutSignal.NoSignal
