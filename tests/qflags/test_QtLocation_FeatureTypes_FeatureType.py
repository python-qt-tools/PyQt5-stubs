...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.FeatureTypes" and flag class "QGeoRouteRequest.FeatureType"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.FeatureType
MultiFlagClass = QtLocation.QGeoRouteRequest.FeatureTypes

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.FeatureType.NoFeature
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.FeatureType.TollFeature
