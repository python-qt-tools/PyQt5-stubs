...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QDBusConnection.RegisterOptions" and flag class "QDBusConnection.RegisterOption"
from PyQt5 import QtDBus

OneFlagClass = QtDBus.QDBusConnection.RegisterOption
MultiFlagClass = QtDBus.QDBusConnection.RegisterOptions

oneFlagRefValue1 = QtDBus.QDBusConnection.RegisterOption.ExportAdaptors
oneFlagRefValue2 = QtDBus.QDBusConnection.RegisterOption.ExportScriptableSlots
