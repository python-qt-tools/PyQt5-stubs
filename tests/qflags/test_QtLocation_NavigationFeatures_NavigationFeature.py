...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoServiceProvider.NavigationFeatures" and flag class "QGeoServiceProvider.NavigationFeature"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoServiceProvider.NavigationFeature
MultiFlagClass = QtLocation.QGeoServiceProvider.NavigationFeatures

oneFlagRefValue1 = QtLocation.QGeoServiceProvider.NavigationFeature.NoNavigationFeatures
oneFlagRefValue2 = QtLocation.QGeoServiceProvider.NavigationFeature.OnlineNavigationFeature
