...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGL.FormatOptions" and flag class "QGL.FormatOption"
from PyQt5 import QtOpenGL

OneFlagClass = QtOpenGL.QGL.FormatOption
MultiFlagClass = QtOpenGL.QGL.FormatOptions

oneFlagRefValue1 = QtOpenGL.QGL.FormatOption.DoubleBuffer
oneFlagRefValue2 = QtOpenGL.QGL.FormatOption.DepthBuffer
