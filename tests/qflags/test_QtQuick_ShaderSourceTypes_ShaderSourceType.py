...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGRendererInterface.ShaderSourceTypes" and flag class "QSGRendererInterface.ShaderSourceType"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGRendererInterface.ShaderSourceType
MultiFlagClass = QtQuick.QSGRendererInterface.ShaderSourceTypes

oneFlagRefValue1 = QtQuick.QSGRendererInterface.ShaderSourceType.ShaderSourceString
oneFlagRefValue2 = QtQuick.QSGRendererInterface.ShaderSourceType.ShaderSourceFile
