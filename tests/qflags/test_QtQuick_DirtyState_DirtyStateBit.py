...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGNode.DirtyState" and flag class "QSGNode.DirtyStateBit"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGNode.DirtyStateBit
MultiFlagClass = QtQuick.QSGNode.DirtyState

oneFlagRefValue1 = QtQuick.QSGNode.DirtyStateBit.DirtyMatrix
oneFlagRefValue2 = QtQuick.QSGNode.DirtyStateBit.DirtyNodeAdded
