...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGAbstractRenderer.MatrixTransformFlags" and flag class "QSGAbstractRenderer.MatrixTransformFlag"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGAbstractRenderer.MatrixTransformFlag
MultiFlagClass = QtQuick.QSGAbstractRenderer.MatrixTransformFlags

oneFlagRefValue1 = QtQuick.QSGAbstractRenderer.MatrixTransformFlag.MatrixTransformFlipY
oneFlagRefValue2 = QtQuick.QSGAbstractRenderer.MatrixTransformFlag.MatrixTransformFlipY
