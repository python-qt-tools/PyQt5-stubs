...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSql.ParamType" and flag class "QSql.ParamTypeFlag"
from PyQt5 import QtSql

OneFlagClass = QtSql.QSql.ParamTypeFlag
MultiFlagClass = QtSql.QSql.ParamType

oneFlagRefValue1 = QtSql.QSql.ParamTypeFlag.In
oneFlagRefValue2 = QtSql.QSql.ParamTypeFlag.Out
