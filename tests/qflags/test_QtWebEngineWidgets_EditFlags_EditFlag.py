...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QWebEngineContextMenuData.EditFlags" and flag class "QWebEngineContextMenuData.EditFlag"
from PyQt5 import QtWebEngineWidgets

OneFlagClass = QtWebEngineWidgets.QWebEngineContextMenuData.EditFlag
MultiFlagClass = QtWebEngineWidgets.QWebEngineContextMenuData.EditFlags

oneFlagRefValue1 = QtWebEngineWidgets.QWebEngineContextMenuData.EditFlag.CanUndo
oneFlagRefValue2 = QtWebEngineWidgets.QWebEngineContextMenuData.EditFlag.CanRedo
