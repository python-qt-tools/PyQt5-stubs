...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QQuickPaintedItem.PerformanceHints" and flag class "QQuickPaintedItem.PerformanceHint"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QQuickPaintedItem.PerformanceHint
MultiFlagClass = QtQuick.QQuickPaintedItem.PerformanceHints

oneFlagRefValue1 = QtQuick.QQuickPaintedItem.PerformanceHint.FastFBOResizing
oneFlagRefValue2 = QtQuick.QQuickPaintedItem.PerformanceHint.FastFBOResizing
