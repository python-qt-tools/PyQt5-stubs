...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoServiceProvider.PlacesFeatures" and flag class "QGeoServiceProvider.PlacesFeature"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoServiceProvider.PlacesFeature
MultiFlagClass = QtLocation.QGeoServiceProvider.PlacesFeatures

oneFlagRefValue1 = QtLocation.QGeoServiceProvider.PlacesFeature.NoPlacesFeatures
oneFlagRefValue2 = QtLocation.QGeoServiceProvider.PlacesFeature.OnlinePlacesFeature
