...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSGRendererInterface.ShaderCompilationTypes" and flag class "QSGRendererInterface.ShaderCompilationType"
from PyQt5 import QtQuick

OneFlagClass = QtQuick.QSGRendererInterface.ShaderCompilationType
MultiFlagClass = QtQuick.QSGRendererInterface.ShaderCompilationTypes

oneFlagRefValue1 = QtQuick.QSGRendererInterface.ShaderCompilationType.RuntimeCompilation
oneFlagRefValue2 = QtQuick.QSGRendererInterface.ShaderCompilationType.OfflineCompilation
