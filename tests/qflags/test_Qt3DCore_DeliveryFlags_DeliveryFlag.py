...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QSceneChange.DeliveryFlags" and flag class "QSceneChange.DeliveryFlag"
from PyQt5 import Qt3DCore

OneFlagClass = Qt3DCore.QSceneChange.DeliveryFlag
MultiFlagClass = Qt3DCore.QSceneChange.DeliveryFlags

oneFlagRefValue1 = Qt3DCore.QSceneChange.DeliveryFlag.BackendNodes
oneFlagRefValue2 = Qt3DCore.QSceneChange.DeliveryFlag.Nodes
