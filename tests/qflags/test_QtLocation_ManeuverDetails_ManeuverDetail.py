...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.ManeuverDetails" and flag class "QGeoRouteRequest.ManeuverDetail"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.ManeuverDetail
MultiFlagClass = QtLocation.QGeoRouteRequest.ManeuverDetails

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.ManeuverDetail.NoManeuvers
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.ManeuverDetail.BasicManeuvers
