...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QGeoRouteRequest.TravelModes" and flag class "QGeoRouteRequest.TravelMode"
from PyQt5 import QtLocation

OneFlagClass = QtLocation.QGeoRouteRequest.TravelMode
MultiFlagClass = QtLocation.QGeoRouteRequest.TravelModes

oneFlagRefValue1 = QtLocation.QGeoRouteRequest.TravelMode.CarTravel
oneFlagRefValue2 = QtLocation.QGeoRouteRequest.TravelMode.PedestrianTravel
