...
### Specific part
# file generated from qflags_test_template.py for QFlags class "QBluetooth.SecurityFlags" and flag class "QBluetooth.Security"
from PyQt5 import QtBluetooth

OneFlagClass = QtBluetooth.QBluetooth.Security
MultiFlagClass = QtBluetooth.QBluetooth.SecurityFlags

oneFlagRefValue1 = QtBluetooth.QBluetooth.Security.NoSecurity
oneFlagRefValue2 = QtBluetooth.QBluetooth.Security.Authorization
