...
class QWizard(QDialog):
    ...
    def sizeHint(self) -> QtCore.QSize: ...
    def setVisible(self, visible: bool) -> None: ...
    def setDefaultProperty(self, className: str, property: str, changedSignal: QtCore.pyqtSignal) -> None: ...
...
class QWizardPage(QWidget):
    ...
    def registerField(self, name: str, widget: QWidget, property: typing.Optional[str] = ..., changedSignal: QtCore.pyqtSignal = ...) -> None: ...
    def field(self, name: str) -> typing.Any: ...
    def setField(self, name: str, value: typing.Any) -> None: ...
