...
class QWinTaskbarProgress(QtCore.QObject):
    ...
    stoppedChanged: typing.ClassVar[QtCore.pyqtSignal]
...
class QWinThumbnailToolBar(QtCore.QObject):
    ...
    def clear(self) -> None: ...
    iconicLivePreviewPixmap: typing.ClassVar[QtCore.pyqtSignal]
    iconicThumbnailPixmap: typing.ClassVar[QtCore.pyqtSignal]
