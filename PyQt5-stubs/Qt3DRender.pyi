...
class QClearBuffers('QFrameGraphNode'):
    ...
    class BufferTypeFlags(sip.simplewrapper):
        ...
        def __or__ (self, other: typing.Union['QClearBuffers.BufferTypeFlags', 'QBuffer.BufferType', int]) -> 'QClearBuffers.BufferTypeFlags': ...
        def __and__(self, other: typing.Union['QClearBuffers.BufferTypeFlags', 'QBuffer.BufferType', int]) -> 'QClearBuffers.BufferTypeFlags': ...
        def __xor__(self, other: typing.Union['QClearBuffers.BufferTypeFlags', 'QBuffer.BufferType', int]) -> 'QClearBuffers.BufferTypeFlags': ...
        def __ror__ (self, other: 'QBuffer.BufferType') -> 'QClearBuffers.BufferTypeFlags': ...
        def __rand__(self, other: 'QBuffer.BufferType') -> 'QClearBuffers.BufferTypeFlags': ...
        def __rxor__(self, other: 'QBuffer.BufferType') -> 'QClearBuffers.BufferTypeFlags': ...
