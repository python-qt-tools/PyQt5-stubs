...
class Qt(sip.simplewrapper):
    ...
    class WindowType(object):
        ...
        def __add__ (self, other: typing.Union['Qt.WindowType', int]) -> 'Qt.WindowFlags': ...
        def __sub__ (self, other: typing.Union['Qt.WindowType', int]) -> 'Qt.WindowFlags': ...
        ...
        def __rand__(self, other: int) -> 'Qt.WindowFlags': ...
