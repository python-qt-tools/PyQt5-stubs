...
class Qt(sip.simplewrapper):
    ...
    class Alignment(sip.simplewrapper):
        ...
        def __index__(self) -> int: ...
        def __int__(self) -> int: ...
        def __or__ (self, other: typing.Union['Qt.Alignemtn', 'Qt.AlignmentFlag', int]) -> 'Qt.Alignemtn': ...
        def __and__(self, other: typing.Union['Qt.Alignemtn', 'Qt.AlignmentFlag', int]) -> 'Qt.Alignemtn': ...
        def __xor__(self, other: typing.Union['Qt.Alignemtn', 'Qt.AlignmentFlag', int]) -> 'Qt.Alignemtn': ...
        def __ror__ (self, other: 'Qt.AlignmentFlag') -> 'Qt.Alignemtn': ...
        def __rand__(self, other: 'Qt.AlignmentFlag') -> 'Qt.Alignemtn': ...
        def __rxor__(self, other: 'Qt.AlignmentFlag') -> 'Qt.Alignemtn': ...
