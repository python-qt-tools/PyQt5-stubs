...
class QFlagsDef(typing.Protocol[TypeQFlagsDef, TypeEnumFlag]):
    ...
    @typing.overload
    def __init__(self: TypeQFlagsDef) -> None: ...

    @typing.overload
    def __init__(self: TypeQFlagsDef, f: typing.Union[TypeQFlagsDef, TypeEnumFlag, int] = 0) -> None: ...

    def __hash__(self) -> int: ...
    def __bool__(self) -> int: ...
    def __invert__(self) -> TypeQFlagsDef: ...
    def __index__(self) -> int: ...
    def __int__(self) -> int: ...
    def __or__ (self, other: typing.Union[TypeQFlagsDef, TypeEnumFlag, int]) -> TypeQFlagsDef: ...
    def __and__(self, other: typing.Union[TypeQFlagsDef, TypeEnumFlag, int]) -> TypeQFlagsDef: ...
    def __xor__(self, other: typing.Union[TypeQFlagsDef, TypeEnumFlag, int]) -> TypeQFlagsDef: ...
    def __ror__ (self, other: TypeEnumFlag) -> TypeQFlagsDef: ...
    def __rand__(self, other: TypeEnumFlag) -> TypeQFlagsDef: ...
    def __rxor__(self, other: TypeEnumFlag) -> TypeQFlagsDef: ...
...
class Qt(sip.simplewrapper):
    ...
    class WindowType(EnumFlag['Qt.WindowFlags', 'Qt.WindowType'], int):    # type: ignore[override, misc]
    ...
    class WindowFlags(QFlagsDef['Qt.WindowFlags', 'Qt.WindowType'], sip.simplewrapper): ...
