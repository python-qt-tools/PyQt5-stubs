...
class Qt(sip.simplewrapper):
    ...
    class WindowType(int):
        ...
        def __add__(self, other: typing.Union['Qt.WindowFlags', 'Qt.WindowType']) -> 'Qt.WindowFlags': ...
        def __sub__(self, other: typing.Union['Qt.WindowFlags', 'Qt.WindowType']) -> 'Qt.WindowFlags': ...
