...
class QAbstractItemModel(QObject):
    ...
    columnsAboutToBeInserted: pyqtSignal
    columnsAboutToBeMoved: pyqtSignal
    columnsAboutToBeRemoved: pyqtSignal
    columnsInserted: pyqtSignal
    columnsMoved: pyqtSignal
    columnsRemoved: pyqtSignal
...
class QAbstractTransition(QObject):
    ...
    targetStatesChanged: pyqtSignal
    targetStateChanged: pyqtSignal
...
class QIODevice(QObject):
    ...
    channelBytesWritten: pyqtSignal
    channelReadyRead: pyqtSignal
    readChannelFinished: pyqtSignal
...
class QHistoryState(QAbstractState):
    ...
    defaultStateChanged: pyqtSignal
    defaultTransitionChanged: pyqtSignal
    historyTypeChanged: pyqtSignal
...
class QSignalTransition(QAbstractTransition):
    ...
    senderObjectChanged: pyqtSignal
...
class QState(QAbstractState):
 	...
 	childModeChanged: pyqtSignal
 	errorStateChanged: pyqtSignal
 	finished: pyqtSignal
 	initialStateChanged: pyqtSignal
 	propertiesAssigned: pyqtSignal
