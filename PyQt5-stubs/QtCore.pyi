...
@typing.overload
def pyqtSlot(*types: typing.Any, name: typing.Optional[str] = ..., revision: int = ...) -> typing.Callable[[FuncT[T]], FuncT[T]]: ...
@typing.overload
def pyqtSlot(*types: typing.Any, name: typing.Optional[str] = ..., result: str = ..., revision: int = ...) -> typing.Callable[[FuncT[T]], FuncT[T]]: ...
@typing.overload
def pyqtSlot(*types: typing.Any, name: typing.Optional[str] = ..., result: typing.Type[T] = ..., revision: int = ...) -> typing.Callable[[FuncT[T]], FuncT[T]]: ...
