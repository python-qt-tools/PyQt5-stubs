...
* [#148](https://github.com/python-qt-tools/PyQt5-stubs/pull/148) add `widgetResizable` parameter to `QScrollArea.__init__()` and
    `objectName` parameter to `QGroupBox.__init__()` .
